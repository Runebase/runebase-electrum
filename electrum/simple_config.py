...
# satoshi per kbyte
FEERATE_MAX_DYNAMIC = 12500000000
FEERATE_WARNING_HIGH_FEE = 900000000
FEERATE_FALLBACK_STATIC_FEE = 40000000
FEERATE_DEFAULT_RELAY = 40000000
FEERATE_MAX_RELAY = 400000000
FEERATE_STATIC_VALUES = [41000000, 50000000, 60000000, 70000000, 80000000, 100000000, 130000000, 180000000, 200000000, 250000000, 300000000]

FEERATE_REGTEST_HARDCODED = 180000  # for eclair compat

FEE_RATIO_HIGH_WARNING = 5.0  # warn user if fee/amount for on-chain tx is higher than this
...
class SimpleConfig(Logger):
    ...
    def convert_version_3(self):
        ...
        if isinstance(base_unit, str):
            ...
            map_ = {'runebase':8, 'mrunebase':5, 'urunebase':2, 'bits':2, 'sat':0}
    ...
    def fee_per_kb(self, dyn: bool=None, mempool: bool=None, fee_level: float=None) -> Optional[int]:
        ...
        """
        if constants.net is constants.RunebaseRegtest:
