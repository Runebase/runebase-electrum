...
def encode_fallback(fallback, currency):
    ...
    """
    if currency in [constants.RunebaseMainnet.SEGWIT_HRP, constants.RunebaseTestnet.SEGWIT_HRP]:
...
base58_prefix_map = {
    constants.RunebaseMainnet.SEGWIT_HRP : (constants.RunebaseMainnet.ADDRTYPE_P2PKH, constants.RunebaseMainnet.ADDRTYPE_P2SH),
    constants.RunebaseTestnet.SEGWIT_HRP : (constants.RunebaseTestnet.ADDRTYPE_P2PKH, constants.RunebaseTestnet.ADDRTYPE_P2SH)
}
